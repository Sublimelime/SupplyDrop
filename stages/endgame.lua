...
function endGame()
   ...
   local possibilities = {
      ...
      {name="effectivity-module",count=math.random(10,30)},
      {name="speed-module-2",count=math.random(10,30)},
      {name="effectivity-module-2",count=math.random(10,30)},
      {name="productivity-module-2",count=math.random(10,30)},
      {name="speed-module-3",count=math.random(1,15)},
      {name="effectivity-module-3",count=math.random(1,15)},
      ...
      {name="logistic-chest-requester",count=math.random(1,5)},
      {name="logistic-chest-active-provider",count=math.random(1,5)},
      {name="logistic-chest-passive-provider",count=math.random(1,5)},
